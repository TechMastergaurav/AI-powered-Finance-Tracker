...
const AddTrasactionForm = ({accounts,categories,editMode=false,initialData=null}) => {
...
{errors.date && (
  ...
  <label htmlFor="isDefault" className='text-sm font-medium'>Recurring Transaction</label>
