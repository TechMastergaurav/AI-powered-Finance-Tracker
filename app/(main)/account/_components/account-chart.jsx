...
const DATE_RANGES = {
    ...
    "6M":{label:"Last Six Month",days:180},
    "1Y":{label:"Last One year",days:365},
...
const AccountChart = ({transactions}) => {
  ...
  return (
    <Card>
  <CardHeader className=" flex-row flex items-center justify-between space-y-0 pb-7">
    <CardTitle className="text-base font-normal">Transaction Overview</CardTitle>
    <Select value={dataRange} onValueChange={(val) => setDataRange(val)}>
  ...
  ${(totals.income - totals.expense).toFixed(2)}
    ...
    { <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Tooltip />
        <Legend />
        <Bar dataKey="income" name="Income" fill="#22c55e" radius={[4,4,0,0]} activeBar={<Rectangle fill="pink" stroke="blue" />} />
        <Bar dataKey="expense" name="Expense" fill="#ef4444"radius={[4,4,0,0]} activeBar={<Rectangle fill="gold" stroke="purple" />} />
      </BarChart>
    </ResponsiveContainer> }
    </div>
